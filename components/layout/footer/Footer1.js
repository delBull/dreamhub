                        ...
                        <div className="col-md-12">
                            ...
                            <div className="footer__bottom">
                                <div className="center mb--30">
                                    ...
                                    <p>Copyright © {new Date().getFullYear()}, Dreamhub es marca registrada de MXHUB Ecosistema Blockchain S.A. de C.V.</p>
                                </div>
                                <ul className="list-social">
                                   {/* <li><a href="#">
                                    ...
                                    <li><a href="https://twitter.com/Dreamhubart" target="_blank">
