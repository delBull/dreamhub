        ...
        <>
            <div className="faq__main flat-tabs" data-aos="fade-up" data-aos-duration={3000}>
                <ul className="menu-tab">
                    <li onClick={() => handleOnClick(1)} className={activeIndex === 1 ? "active" : ""}><h6 className="fs-14">Dreamhub</h6></li>
                    <li onClick={() => handleOnClick(2)} className={activeIndex === 2 ? "active" : ""}> <h6 className="fs-14">Tokenización</h6></li>
                    <li onClick={() => handleOnClick(3)} className={activeIndex === 3 ? "active" : ""}><h6 className="fs-14">Inversión</h6></li>
                    <li onClick={() => handleOnClick(4)} className={activeIndex === 4 ? "active" : ""}><h6 className="fs-14">Seguridad & Soporte</h6></li>
                </ul>
                        ...
                        <div className="flat-accordion row">
                            <div className={`col-md-6 ${oneCol?"col-md-12":"col-sm-12"} `}>
                                <div className={isActive.key == 1 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleToggle(1)}>
                                    <h6 className={isActive.key == 1 ? "toggle-title active" : "toggle-title"}><span>01.</span> ¿Qué es Dreamhub? <span className="icon-plus" /></h6>
                                    <div className="toggle-content" style={{ display: `${isActive.key == 1 ? "block" : "none"}` }}>
                                        <p>
                                        Dreamhub es una agencia de tokenización líder que se especializa en convertir activos físicos y digitales 
                                        en tokens digitales a través de tecnología blockchain
                                        </p>
                                    </div>
                                </div>
                                <div className={isActive.key == 2 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleToggle(2)}>
                                    <h6 className={isActive.key == 2 ? "toggle-title active" : "toggle-title"}><span>02.</span> ¿En qué se especializa Dreamhub?<span className="icon-plus" /></h6>
                                    <div className="toggle-content" style={{ display: `${isActive.key == 2 ? "block" : "none"}` }}>
                                        <p>
                                        Dreamhub se especializa en servicios de tokenización, lo que significa que transformamos una variedad de activos, 
                                        desde bienes raíces hasta obras de arte, en tokens digitales para simplificar su gestión, inversión y venta.
                                        </p>
                                    </div>
                                </div>
                                <div className={isActive.key == 3 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleToggle(3)}>
                                    <h6 className={isActive.key == 3 ? "toggle-title active" : "toggle-title"}><span>03.</span> ¿Què es la Tokenización?<span className="icon-plus" /></h6>
                                    <div className="toggle-content" style={{ display: `${isActive.key == 3 ? "block" : "none"}` }}>
                                        <p>
                                        La tokenización es un proceso que implica la conversión de activos físicos o digitales 
                                        en tokens digitales en una cadena de bloques (blockchain). Cada token representa una parte o propiedad de ese activo.
                                        </p>
                                    </div>
                                </div>
                                <div className={isActive.key == 4 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleToggle(4)}>
                                    <h6 className={isActive.key == 4 ? "toggle-title active" : "toggle-title"}><span>04.</span> ¿Cuáles son los beneficios de tokenizar activos?<span className="icon-plus" /></h6>
                                    <div className="toggle-content" style={{ display: `${isActive.key == 4 ? "block" : "none"}` }}>
                                        <p>
                                        La tokenización aumenta la liquidez de los activos, facilita la inversión y brinda una mayor accesibilidad 
                                        a la inversión en una variedad de activos. También fomenta la diversificación de inversiones.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div className={`col-md-6 ${oneCol?"col-md-12":"col-sm-12"} `}>
                                <div className={isActive.key == 5 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleToggle(5)}>
                                    <h6 className={isActive.key == 5 ? "toggle-title active" : "toggle-title"}><span>05.</span> ¿Para quién es Dreamhub adecuado? <span className="icon-plus" /></h6>
                                    <div className="toggle-content" style={{ display: `${isActive.key == 5 ? "block" : "none"}` }}>
                                        <p>
                                        Dreamhub es adecuado para empresas, emprendedores y cualquier persona que busque aprovechar 
                                        los beneficios de la tokenización, ya sea para sus propios activos o para invertir en otros.
                                        </p>
                                    </div>
                                </div>
                                <div className={isActive.key == 6 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleToggle(6)}>
                                    <h6 className={isActive.key == 6 ? "toggle-title active" : "toggle-title"}><span>06.</span> ¿Dónde opera Dreamhub?<span className="icon-plus" /></h6>
                                    <div className="toggle-content" style={{ display: `${isActive.key == 6 ? "block" : "none"}` }}>
                                        <p>
                                        Dreamhub opera a nivel internacional, lo que permite a personas de todo el mundo 
                                        acceder a nuestros servicios de tokenización.
                                        </p>
                                    </div>
                                </div>
