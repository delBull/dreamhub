                            ...
                            <h5 className="sub-heading"><span>La "magia" de la tokenización</span></h5>
                                ...
                                <div className={isActive.key == 1 ? "flat-toggle active" : "flat-toggle"} onClick={() => handleToggle(1)}>
                                    ...
                                    <div className="toggle-content" style={{ display: `${isActive.key == 1 ? "block" : "none"}` }}>
                                        ...
                                        de tu casa. Estos tokens son como los ladrillos digitales de tu fortaleza. ¿La magia? 
                                        Ahora, puedes compartir esos ladrillos con otros y, juntos, construir algo más grande. 
                                        ¡Es como tener una fortaleza digital donde todos son copropietarios!
                                        </p>
                                    </div>
                                </div>
